...
(function (root) {
  ...
  L.rules.desglose = {
    ...
    oiVerbs: ["piacere", "dispiacere", "servire", "mancare", "sembrare", "interessare", "dire", "dare",
      "chiedere", "domandare", "mandare", "scrivere", "telefonare", "spiegare", "consigliare", "portare",
      "passare", "prestare", "regalare", "offrire", "fare", "mostrare", "rispondere", "raccontare",
      "andare", "confermare", "inviare", "permettere", "convenire", "bastare", "importare"],
    ...
    // «en esta frase»: only real idiomatic uses of a verb form.
    idioms: {
      figurati: "¡imaginate!; también «¡de nada!»",
      dai: "¡dale!, ¡vamos!",
