...
"blocks": [
 ...
 {"h": "Adverbios con dos sentidos",
  "r": "Cuidado con *ancora* (todavía / otra vez), *mai* (nunca / alguna "
       "vez) y *più* (más / ya no). El contexto y el *non* deciden.",
...
"blocks": [
 {"h": "Sumar, oponer, corregir",
  "r": "*e* suma, *ma* opone, *invece* contrasta dos sujetos. Ante vocal, "
       "sobre todo ante *e*, *e* se vuelve *ed*: *Anna ed Elena*.",
 ...
 {"h": "Causa y consecuencia",
  ...
  "ex": [["Siccome piove, restiamo a casa.", "Como llueve, nos quedamos en casa."],
 ...
 {"h": "Antes, después, apenas",
  "r": "*prima di* + infinitivo, *dopo* + infinitivo **compuesto**, *appena* "
       "(apenas), *finché* (hasta que), *poi* (después), *alla fine* (al "
       "final).",
 ...
 {"h": "Ordenar un argumento",
  "r": "Para ordenar ideas: *innanzitutto* (ante todo), *in primo luogo*, "
       "*poi*, *d'altra parte* (por otro lado), *intanto* (mientras tanto), "
 ...
 {"h": "Los que piden congiuntivo",
  "r": "Estos conectores van **siempre** con congiuntivo: *benché, sebbene* "
       "(aunque), *affinché* (para que), *purché* (con tal de que), *prima "
       "che* (antes de que).",
  ...
  "more": ["La lista completa: *benché*, *sebbene*, *nonostante*, *malgrado* "
           ...
           "(con tal de que); *prima che* (antes de que). *Perché* con "
           "indicativo es causal (porque); con congiuntivo, final (para que)."]},
]},
...
"blocks": [
 {"h": "Imperfetto: la forma",
  ...
  "warn": "*noi* termina en *-ssimo* (*parlassimo*), parecido al "
          "superlativo. Y *io* y *tu* son iguales: otra vez, poné el "
          "pronombre."},
 ...
 {"h": "Cuándo aparecen",
  "r": "Si el principal está **en pasado o en condicional**, nada de "
       "congiuntivo presente: **imperfetto** si es simultáneo, "
       "**trapassato** si es anterior.",
  ...
  "more": ["Lo posterior también va en imperfetto después de un condicional "
           ...
           "condizionale passato: lo ves en la semana 31."]},
 ...
 {"h": "Ojalá, como si",
  ...
  "ex": [["Magari fosse vero!", "¡Ojalá fuera cierto!"],
         ...
         ["Fosse anche l'ultima volta, non ci vado.", "Aunque fuera la última vez, no voy."]],
...
"blocks": [
 {"h": "La forma",
  "r": "*avrei* o *sarei* + participio, con las reglas de auxiliar y "
       "concordancia de siempre: *avrei parlato*, *sarei andato/a*, *mi "
       "sarei alzato/a*.",
  "table": {"head": ["", "con avere", "con essere"],
 ...
 {"h": "Uso 2: el futuro en el pasado",
  "r": "«Dijo que vendría» = *ha detto che sarebbe venuto*. Si el punto de "
       "referencia está en el pasado, condicional **compuesto**, nunca "
       "simple.",
  "ex": [["Mi ha promesso che sarebbe tornato.", "Me prometió que volvería."],
         ["Non sapevo che avrebbe portato gli amici.", "No sabía que traería a los amigos."],
...
"blocks": [
 {"h": "El cuadro con congiuntivo",
  ...
  "ex": [["Credo che sia partito / parta / parta domani.", "Creo que salió / sale / sale mañana."],
         ["Credevo che fosse partito / partisse / sarebbe partito.", "Creía que había salido / salía / saldría."]]},
 ...
 {"h": "Lo posterior en el pasado",
  ...
  "ex": [["Ha detto che sarebbe arrivato alle otto.", "Dijo que llegaría a las ocho."],
         ...
         ["Pensavo che sarebbe stato più facile.", "Pensaba que sería más fácil."]],
  ...
  "more": ["La forma es *avrei* / *sarei* + participio (*avrebbe capito*, "
           "*sarebbe arrivato*). La tabla completa y sus otros usos los "
 ...
 {"h": "Con indicativo, la misma lógica",
  ...
  "ex": [["So che è partito / parte / partirà.", "Sé que salió / sale / saldrá."],
         ["Sapevo che era partito / partiva / sarebbe partito.", "Sabía que había salido / salía / saldría."]]},
...
"blocks": [
 ...
 {"h": "Otras formas de hipótesis",
  "r": "Piden congiuntivo: *a meno che non*, *purché*, *a patto che*, *nel "
       "caso in cui*, *qualora* (formal). Y *magari* + imperfetto para "
       "desear.",
...
"blocks": [
 ...
 {"h": "chi: sin antecedente",
  ...
  "ex": [["Chi dorme non piglia pesci.", "Camarón que se duerme se lo lleva la corriente."],
...
"blocks": [
 ...
 {"h": "venire: la pasiva de acción",
  "r": "*venire* reemplaza a *essere* **solo en tiempos simples** y subraya "
       "el proceso, no el estado. Típico de la prensa y de la "
       "administración.",
 ...
 {"h": "andare: la pasiva de obligación",
  ...
  "ex": [["Il modulo va compilato in stampatello.", "El formulario debe llenarse en imprenta."],
...
"blocks": [
 {"h": "Las formas regulares",
  "r": "Terminaciones propias para cada conjugación. En *-ere* hay **dos "
       "series** en tres personas; las dos valen, la de *-etti* es más "
       "común.",
 ...
 {"h": "El patrón 1-3-6 de los irregulares",
  "r": "Los irregulares lo son **solo en *io*, *lui/lei* y *loro***, sobre "
       "la misma raíz: *-i, -e, -ero*. Las otras tres personas son "
       "regulares.",
 ...
 {"h": "Cuándo se usa",
  "r": "Para hechos **concluidos y sin relación con el presente**: narración "
       "histórica y literaria. El passato prossimo mantiene el vínculo con "
       "el ahora.",
 ...
 {"h": "Trapassato remoto",
  "r": "*ebbi* / *fui* + participio, solo detrás de *quando, dopo che, "
       "appena* con la principal en passato remoto. Es literario: **alcanza "
       "con reconocerlo**.",
...
"blocks": [
 {"h": "Los cuatro congiuntivos",
  ...
  "table": {"head": ["Tiempo", "Forma", "Cuándo"],
            "rows": [["presente", "che io parli / prenda", "principal en presente, acción simultánea o posterior"],
                     ["passato", "che io abbia parlato / sia andato", "principal en presente, acción anterior"],
                     ["imperfetto", "che io parlassi / prendessi", "principal en pasado o condicional, simultánea"],
                     ["trapassato", "che io avessi parlato / fossi andato", "principal en pasado, acción anterior"]]}},
 ...
 {"h": "Passato remoto y discurso indirecto",
  "r": "El **passato remoto** narra el pasado cerrado de libros y noticias: "
       "*fu, ebbe, fece, disse*. Al reportar, los tiempos **retroceden** un "
       "paso.",
